 ...
 *
 * Disassembly of DSDT.aml, Sun Nov  8 12:19:36 2015
 *
 * Original Table Header:
 *     Signature        "DSDT"
 *     Length           0x0001696B (92523)
 *     Revision         0x02
 *     Checksum         0x06
 *     OEM ID           "_ASUS_"
...
DefinitionBlock ("DSDT.aml", "DSDT", 2, "_ASUS_", "Notebook", 0x00000012)
{
    ...
    External (_SB_.IAOE.WLLA, IntObj)
    ...
    Name (VGAF, One)
    OperationRegion (GNVS, SystemMemory, 0xDAB1BC18, 0x02B2)
            ...
            Method (WMNB, 3, NotSerialized)
            {
                ...
                If (LEqual (Local0, 0x53545344))
                {
                    ...
                    If (LEqual (IIA0, 0x00120042))
                    {
                        ...
                        Else
                        {
                            Subtract (0x00010000, 0x0A, Local2)
                            And (Local2, 0xFFFF, Local2)
                            Return (Local2)
                        }
                    }
...
Else
{
    ...
    Scope (_SB)
    {
        Device (LID)
        {
            ...
            {
                Store (One, Local0)
                Store (^^PCI0.LPCB.EC0.RPUN (0x11), Local0)
                If (LEqual (Local0, Ones))
                {
                    Store (One, Local0)
                }
    ...
    Scope (\)
    {
        ...
        {
            Return (\_SB.PCI0.LPCB.EC0.RPUN (0x11))
        }
